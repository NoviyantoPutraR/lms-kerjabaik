...
export const Header: React.FC<HeaderProps> = ({ toggleDarkMode, isDarkMode }) => {
  return (
    <header className="sticky top-0 z-50 w-full border-b border-slate-200 bg-surface-light/90 backdrop-blur-md dark:bg-surface-dark/90 dark:border-slate-800 transition-all duration-300">
      <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6 sm:px-12 lg:px-16">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-primary-landing text-white">
            <span className="material-symbols-outlined text-[20px]">school</span>
          </div>
          <h2 className="text-base font-bold tracking-tight text-text-main dark:text-white font-lexend">
        ...
        <div className="flex items-center gap-4">
          ...
          <Link to="/login" className="flex h-9 items-center justify-center rounded-full bg-primary-landing px-5 text-xs font-bold text-white shadow-lg shadow-primary-landing/20 transition-all hover:bg-primary-landing/90 hover:-translate-y-0.5">
            Daftar Gratis
          </Link>
        </div>
      </div>
